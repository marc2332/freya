...
impl Output {
    ...
    pub fn push_ws_message(&mut self, bundle: BundleFormat, message: &freya_hotreload::ClientMsg) {
    ...
    fn render_stats(&self, frame: &mut Frame<'_>, area: Rect, state: RenderState) {
        let [current_platform, app_features]: [_; 2] =
    ...
    fn render_log(
        ...
        //
        // Reserve only the available space below the viewport, matching the original CLI layout.
