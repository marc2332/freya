...
impl CommandWithPlatformOverrides<BuildArgs> {
            ...
            || self.server.is_some()
        {
            match self.server.as_mut() {
                ...
                None => {
                    ...
                    args.platform = crate::Platform::host();
                    args.renderer = Some(crate::Renderer::Native);
                    args.bundle = Some(crate::BundleFormat::host());
    ...
    pub async fn build(self) -> Result<StructuredOutput> {
        ...
        let build_server = Self::build_server_inner(&targets.server, mode.clone());
