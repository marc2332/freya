...
Dioxus, the UI library in which Freya is built on, has recently released a new version `0.5`, adding a bunch of new features. If I had to describe their releasew with one word, it would be **Simplicity**.
