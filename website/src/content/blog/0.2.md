...
`Sidebar` is a new component to let you have have a menu in the left side and content in the right side, this is specially useful when used in combination with `freya-router` and [`NativeRouter`](#-nativerouter).
