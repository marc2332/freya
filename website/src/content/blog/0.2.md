...
You compose the table combining the different available components like `Table`, `TableRow`, `TableCell`, etc. This flexibility gives you complete control over the data, so you can do things like sorting and then just feed it. 
