...
#### Alignments
The new `space-between` / `space-around` / `space-evenly` mimic the behavior of CSS, you can find more info in [`main_align`](https://docs.rs/freya/0.3/freya/elements/image/constant.main_align.html).
