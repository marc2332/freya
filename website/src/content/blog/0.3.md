...
![image](https://hackmd.io/_uploads/rJSS4mbegx.png)

This is https://freyaui.dev/ but made with Freya it self! Source code in [GitHub](https://github.com/marc2332/freya/blob/main/examples/website.rs)

### Incremental Rendering
For every change in the UI Freya used to rerender all the app, but now it will only render those parts affected by the UI changes. This way it ends up rendering faster as there is less work to do.

For the purpose of internal debugging, I added a feature called `fade-cached-incremental-areas` to showcase this feature. The parts that do not to render again will slowly fade out (this was inspired by an Iced video I saw some time ago). 
...
![image](https://hackmd.io/_uploads/HynXN9i0Je.png)
...
![image](https://hackmd.io/_uploads/rk-R89s01g.png)
...
![image](https://hackmd.io/_uploads/HJ-3_qoRkl.png)


### Images

#### Aspect Ratio and cover
...
In addition to that, a new `cover` attribute has been added to center the rendered image inside its bounds.

[Insert Video]

Source code of the example on [GitHub](https://github.com/marc2332/freya/blob/main/examples/images_slideshow.rs).
...
Source code of an example on [GitHub](https://github.com/marc2332/freya/blob/main/examples/image_cache_key.rs).
...
![image](https://hackmd.io/_uploads/B1a-JTlleg.png)

Other improvements like selecting with `Control + Shift` have been added as well.
...
![image](https://hackmd.io/_uploads/H1HI1Tlglx.png)
...
![image](https://hackmd.io/_uploads/ByshJ6ggxl.png)

Here there is a collection of some of the components, with a refreshed style.
![image](https://hackmd.io/_uploads/HJTv9cjCJg.png)
...
Also, now most-important built-in components offer previews embedded in docs.rs so you can see how a component looks like before even using it.
...
Source code of the example on [GitHub](https://github.com/marc2332/freya/blob/main/examples/animated_position.rs).

Here is another example of cards that can be dragged and dropped:

[Insert Video]

Source code of the example on [GitHub](https://github.com/marc2332/freya/blob/main/examples/drag_drop.rs).
...
Here is an example of a grid, where each element is identified by a number. It doesnt matter that the elements get shuffled because each one is identified, therefore we can know where it comes from and where it goes and thus animate the movement.

The implementation could be improved to make the animation more fluid.

[Insert Video]

Source code of the example on [GitHub](https://github.com/marc2332/freya/blob/main/examples/grid_shuffle.rs).
...
![image](https://hackmd.io/_uploads/r1wehneleg.png)

Source code of the example on [GitHub](https://github.com/marc2332/freya/blob/main/examples/selectable_text.rs).
...
Source code of the example on [GitHub](https://github.com/marc2332/freya/blob/main/examples/animated_overflow_content.rs).
...
Source code of the example on [GitHub](https://github.com/marc2332/freya/blob/main/examples/resizable_container.rs).
...
![image](https://hackmd.io/_uploads/r1U1FTleel.png)

Source code of the example on [GitHub](https://github.com/marc2332/freya/blob/main/examples/tooltip.rs).
...
[Insert Video of Sequential Animation]

Source code of the example on [GitHub](https://github.com/marc2332/freya/blob/main/examples/sequential_animation.rs).
...
![image](https://hackmd.io/_uploads/rJX5t9oAJg.png)
